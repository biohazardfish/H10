-- One-shot runtime audit for the H10 Continuous Body Field project.
-- Run while the demo or live bridge is active; results are written to /tmp.

local output_path = "/tmp/h10_continuous_runtime_audit.txt"
local lines = {}
...
if not file then
  reaper.ShowConsoleMsg("[H10 Continuous audit] " .. tostring(err) .. "\n")
  return
end
file:write(table.concat(lines, "\n"), "\n")
file:close()
reaper.ShowConsoleMsg("[H10 Continuous audit] wrote " .. output_path .. "\n")
